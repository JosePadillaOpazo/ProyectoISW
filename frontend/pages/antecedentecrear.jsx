...
const AntecedenteCrear = () => {
  ...
  const [parvulo, verParvulo] = useState([])
  const [enfermedad, verEnfermedad] = useState([])
  const [discapacidad, verDiscapacidad] = useState([])
  ...
  const [antecedente, AntecedenteVer] = useState({
    _id:'',
    parvulo: '',
    discapacidad: '',
    enfermedad: '',
